...
Route::middleware(['auth:sanctum', \App\Http\Middleware\EnsureCompanySetup::class])->group(function () {
    ...
    // Company Setup Wizard Draft routes
    Route::get('/company-setup/draft/{id}', [\App\Http\Controllers\CompanySetupController::class, 'getDraftApi']);
    Route::post('/company-setup/draft', [\App\Http\Controllers\CompanySetupController::class, 'saveDraftApi']);
    ...
    Route::match(['POST', 'PUT', 'PATCH'], '/products/{product}/update-prices', [ProductController::class, 'updatePrices']);
    ...
    Route::get('/test-accounting', function () {
        ...
        // Banking routes
        Route::get('/bank-accounts/transfers-list', [BankAccountController::class , 'transfersList']);
