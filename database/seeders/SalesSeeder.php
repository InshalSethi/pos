...
class SalesSeeder extends Seeder
{
    ...
    {
        // Check if seeder-generated sales data already exists
        if (Sale::where('notes', 'Generated by seeder')->exists()) {
            $this->command->info('Seeder sales data already exists. Skipping sales seeding.');
            return;
        }
