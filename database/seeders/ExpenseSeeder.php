...
class ExpenseSeeder extends Seeder
{
    ...
    {
        // Check if seeder-generated expense data already exists
        if (Expense::where('notes', 'Generated by seeder')->exists()) {
            $this->command->info('Seeder expense data already exists. Skipping expense seeding.');
            return;
        }
