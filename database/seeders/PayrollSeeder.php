...
class PayrollSeeder extends Seeder
{
    ...
    {
        // Check if seeder-generated payroll data already exists
        if (PayrollRecord::where('notes', 'Generated by seeder')->exists()) {
            $this->command->info('Seeder payroll data already exists. Skipping payroll seeding.');
            return;
        }
