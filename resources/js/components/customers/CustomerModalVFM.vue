<template>
  <VueFinalModal
    ...
    content-class="relative flex flex-col w-full max-w-4xl max-h-[90vh] mx-4 bg-white dark:bg-zinc-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-zinc-800 rounded-2xl shadow-2xl overflow-hidden"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    // Load customer data when component is created or customer prop changes
