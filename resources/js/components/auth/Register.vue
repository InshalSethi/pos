            ...
            <form class="space-y-2.5" @submit.prevent="handleRegister">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <div>
                  ...
                  />
                  <p v-if="errors.first_name" class="mt-0.5 text-[10px] text-red-600 font-medium">{{ errors.first_name[0] }}</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Doe"
                  />
                  <p v-if="errors.last_name" class="mt-0.5 text-[10px] text-red-600 font-medium">{{ errors.last_name[0] }}</p>
                </div>
              </div>
