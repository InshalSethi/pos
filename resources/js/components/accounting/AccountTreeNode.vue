<template>
  <div class="select-none">
    ...
    <div
      :class="[
        'flex items-center justify-between p-3.5 my-1.5 rounded-2xl transition-all border shadow-sm',
    ...
    >
      ...
      <!-- Right Column: Balance + Status + Icons Only Actions -->
      <div class="flex items-center gap-5 shrink-0">
        ...
        <div class="inline-flex items-center bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl shadow-sm divide-x divide-slate-200 dark:divide-zinc-800 overflow-hidden shrink-0">
          ...
          <!-- Lock Icon for Cash/System Account, Delete Icon for Custom Accounts -->
          <button
            v-if="isLocked(account)"
            type="button"
            disabled
