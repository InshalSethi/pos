<template>
  <div class="min-h-screen bg-gray-50">
        ...
        <div class="flex justify-between items-center py-6">
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">Manage your supplier network and partnerships</p>
            </div>
          </div>
          <button
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-semibold text-gray-900">{{ formatNumber(statistics.total_suppliers || 0) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-semibold text-gray-900">{{ formatNumber(statistics.active_suppliers || 0) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-gray-500">With Orders</p>
              <p class="text-2xl font-semibold text-gray-900">{{ formatNumber(statistics.suppliers_with_orders || 0) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-semibold text-gray-900">${{ formatNumber(statistics.total_supplier_value || 0) }}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div class="md:col-span-2">
            ...
            <div class="relative">
              ...
              <input
                v-model="searchQuery"
                type="text"
                class="block w-full pl-10 pr-3 py-2 bg-white dark:bg-[#1E1E1E] border border-gray-300 dark:border-[#2E2E2E] rounded-lg focus:outline-none focus:ring-1 focus:ring-slate-200 focus:border-slate-300 dark:focus:ring-slate-700 dark:focus:border-slate-700 dark:text-slate-300 placeholder-gray-400"
          ...
          <div>
            ...
            <select
              ...
              class="block w-full px-3 py-2 bg-white dark:bg-[#1E1E1E] border border-gray-300 dark:border-[#2E2E2E] dark:text-slate-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-slate-200 focus:border-slate-300 dark:focus:ring-slate-700 dark:focus:border-slate-700"
            >
      ...
      <!-- Supplier Cards/Table -->
      <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <!-- Loading State -->
        <div v-if="loading" class="flex items-center justify-center py-12">
          <div class="flex items-center space-x-2">
            <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-green-600"></div>
            <span class="text-gray-600">Loading suppliers...</span>
          </div>
        </div>

        <!-- Empty State -->
        <div v-else-if="suppliers.data && suppliers.data.length === 0" class="text-center py-12">
            ...
            >
              ...
              <div class="mt-4 grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span class="ml-1 text-gray-900">{{ supplier.email || '-' }}</span>
                </div>
                <div>
                  <span class="text-gray-500">Phone:</span>
                  <span class="ml-1 text-gray-900">{{ supplier.phone || '-' }}</span>
                </div>
                <div>
                  <span class="text-gray-500">City:</span>
                  <span class="ml-1 text-gray-900">{{ supplier.city || '-' }}</span>
                </div>
                <div>
                  <span class="text-gray-500">Terms:</span>
                  <span class="ml-1 text-gray-900">{{ supplier.payment_terms_days ? supplier.payment_terms_days + ' days' : '-' }}</span>
                </div>
              </div>
              ...
              <div class="mt-4 flex justify-end space-x-2">
                <button
                  ...
                  class="inline-flex items-center px-3 py-1 text-xs font-medium text-green-600 bg-green-50 rounded-md hover:bg-green-100"
                >
                  View
                </button>
                <button
        ...
        <!-- Pagination -->
        <div v-if="suppliers.last_page > 1" class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p class="text-sm text-gray-700">
                  Showing
                  <span class="font-medium">{{ ((suppliers.current_page - 1) * suppliers.per_page) + 1 }}</span>
                  to
                  <span class="font-medium">{{ Math.min(suppliers.current_page * suppliers.per_page, suppliers.total) }}</span>
                  of
...
export default {
  ...
  setup() {
    ...
    const suppliers = ref({ data: [], current_page: 1, last_page: 1 });
    ...
    const editSupplier = (supplier) => {
      ...
      console.log('Original supplier object:', supplier);
      ...
      selectedSupplier.value = { ...supplier };
      console.log('selectedSupplier after copy:', selectedSupplier.value);
      console.log('selectedSupplier keys:', Object.keys(selectedSupplier.value));

      showEditModal.value = true;
      console.log('showEditModal set to:', showEditModal.value);

      // Add a small delay to see if modal opens
      setTimeout(() => {
        console.log('After timeout - showEditModal:', showEditModal.value);
        console.log('After timeout - selectedSupplier:', selectedSupplier.value);
      }, 500);
    };
