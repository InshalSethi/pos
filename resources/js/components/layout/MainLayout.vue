        ...
        <div class="relative flex-1 w-full min-w-0" v-else>
          ...
          >
            ...
            <div class="py-1 border-t border-gray-100 dark:border-zinc-800">
              <a :href="addCompanyUrl" class="flex items-center px-4 py-2.5 text-[13px] font-semibold text-emerald-700 bg-emerald-50/70 hover:bg-emerald-100 dark:bg-emerald-950/30 dark:hover:bg-emerald-900/40 dark:text-emerald-400 transition-colors w-full text-left" @click="showCompanySwitcher = false">
              ...
              >
                ...
                <div class="py-1">
                  ...
                  <router-link
                    ...
                    @click="showUserMenu = false"
                  >
                    <svg class="flex-shrink-0 h-5 w-5 mr-3.5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2H5zM5 14a2 2 0 00-2 2v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 00-2-2H5z" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/></svg>
...
const toggleSidebar = () => {
  ...
  if (sidebarCollapsed.value) {
    ...
    showSidebarBankingMenu.value = false;
  }
};
...
const addCompanyUrl = computed(() => {
  const token = localStorage.getItem('auth_token');
  const baseUrl = '/company-setup?mode=create_new&start_fresh_flow=true';
