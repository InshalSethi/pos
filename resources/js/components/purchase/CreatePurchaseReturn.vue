          ...
          <div class="space-y-3 pt-2">
            ...
            <div v-if="form.payment_method === 'mixed'" class="bg-slate-50 dark:bg-zinc-800/80 p-3 rounded-xl border border-slate-200 dark:border-zinc-700 space-y-3">
              ...
              <div class="space-y-2">
                ...
                <div v-for="(split, sIdx) in form.bank_splits" :key="sIdx" class="bg-white dark:bg-zinc-900 p-2 rounded-xl border border-slate-200 dark:border-zinc-700 w-full max-w-full">
                  <div class="flex items-center gap-1.5 w-full relative">
                    <!-- Custom Floating Select Trigger Button -->
                    <div class="relative flex-1 min-w-0">
                      <button
                        type="button"
                        @click.stop="toggleBankSplitDropdown(sIdx)"
                        class="w-full flex items-center justify-between gap-1 py-1.5 px-2.5 text-[11px] bg-slate-50 dark:bg-zinc-800 border border-slate-300 dark:border-zinc-700 rounded-lg font-semibold text-slate-800 dark:text-zinc-100 hover:bg-slate-100 dark:hover:bg-zinc-750 focus:outline-none focus:ring-1 focus:ring-blue-500 cursor-pointer transition-colors text-left"
                      >
                      ...
                      <div
                        ...
                        class="absolute left-0 top-full mt-1 w-64 z-50 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-xl shadow-xl py-1 max-h-48 overflow-y-auto animate-fade-in"
                      >
                    ...
                    <input
                      ...
                      min="0"
                      placeholder="0.00"
                      class="w-20 shrink-0 py-1.5 px-2 text-xs text-right bg-slate-50 dark:bg-zinc-800 border border-slate-300 dark:border-zinc-700 rounded-lg font-bold text-slate-800 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    />
                    ...
                    <button
                      ...
                      class="shrink-0 text-slate-400 hover:text-rose-600 p-1 rounded-lg transition-colors"
