  ...
  <teleport to="body">
    ...
    >
      ...
      >
        ...
        <!-- Active Filter Badge Counter Banner -->
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
          ...
          <div class="space-y-1.5 relative" @click.stop>
            ...
            <div class="relative">
              ...
              >
                <span class="truncate pr-2" :class="{ 'text-slate-400 dark:text-zinc-500': !productSummaryLabel }">
                  {{ productSummaryLabel || 'Select a Top Selling / Purchased Product' }}
                </span>
            ...
            <p class="text-[11px] text-slate-400 dark:text-zinc-500">
              Select from top items to isolate bills containing that product.
            </p>
          </div>
          ...
          <!-- 3. Bill / Purchase Order Number Search Input -->
...
const warehouseSummaryLabel = computed(() => {
  ...
  if (ids.length === 0) return 'All Warehouses / Locations';
  if (ids.length === 1) {
