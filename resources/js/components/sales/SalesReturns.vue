            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="returnItem in returns" :key="returnItem.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  {{ returnItem.original_sale?.sale_number || 'N/A' }}
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  {{ returnItem.customer?.name || 'Walk-in Customer' }}
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  {{ formatDate(returnItem.sale_date) }}
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  ${{ Math.abs(returnItem.total_amount) }}
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  <button @click="printReturn(returnItem)" class="text-green-600 hover:text-green-900 mr-3">Print</button>
