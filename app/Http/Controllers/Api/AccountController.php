...
class AccountController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'account_subtype' => 'required|in:current_asset,fixed_asset,other_asset,cash_and_bank,current_liability,long_term_liability,other_liability,equity,owner_equity,operating_revenue,other_revenue,operating_income,cost_of_goods_sold,cost_of_sales,operating_expense,other_expense',
